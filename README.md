...
| `npx tsx scripts/extended-repair.ts <bundle-dir>` | Fix what --extended finds: mesh hygiene + floater removal → NEW cleaned bundle with before/after receipt (source untouched) |
