...
| Pretrained policies in the certified world, zero training | NVIDIA's lift policy delivers a crate to **2.6 cm** of goal at lunar gravity; a Unitree Go2 locomotion policy walks **1.10 m** on the repaired floor without falling (Isaac Lab flat-terrain checkpoint) | [`assets/isaac/g4-policy-lift.mp4`](assets/isaac/g4-policy-lift.mp4); [`isaac/cluster/g7b.py`](isaac/cluster/g7b.py) |
