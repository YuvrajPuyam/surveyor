...
| Paired traversal receipt | 15 identical navmesh routes, one controller: raw world **0/15** reached, repaired world **13/15** | [`scripts/paired-receipt.ts`](scripts/paired-receipt.ts) |
