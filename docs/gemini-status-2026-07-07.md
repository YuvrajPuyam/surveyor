...
| 4 | Agent repair | hero world F→A, 75/75 recorded outcomes incl. organic fail-revert-adapt (its slab patch created a new step; the certifier caught its own repair); replayable cassette; repaired bundle regenerates from repo+cassette alone |
